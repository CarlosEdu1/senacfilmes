...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      <nav className="flex gap-4 justify-between items-end bg-blue-900 w-full p-3">
        <h1 className ='flex items-center text-5x1 text-red-400 font-bold uppercase'>
     ...
     <Card titulo="As marvels" nota = {8.9} />
     <Card titulo="Dinheiro facil" nota = {7.8}/>
     </section>
